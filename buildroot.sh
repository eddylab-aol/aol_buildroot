...
rm $ROOTFS/etc/rc3.d/*bootlogs
rm $ROOTFS/etc/rc3.d/*rmnologin

rm $ROOTFS/etc/rc6.d/*brightness
rm $ROOTFS/etc/rc6.d/*udev
rm $ROOTFS/etc/rc6.d/*urandom
rm $ROOTFS/etc/rc6.d/*sendsigs
rm $ROOTFS/etc/rc6.d/*hwclock.sh
rm $ROOTFS/etc/rc6.d/*umountnfs.sh
rm $ROOTFS/etc/rc6.d/*networking
rm $ROOTFS/etc/rc6.d/*umountfs
rm $ROOTFS/etc/rc6.d/*umountroot
rm $ROOTFS/etc/rc6.d/*reboot
